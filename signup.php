    ...
    <body>
        ...
        <script>
            ...
            $("#signup").submit(function (e) {
                ...
                var data = {"action": "signup", "user": user, "pass": pass};
...
//                        err.html("Please wait...");
                    ...
                    if (result.user_num > 0) {
                        err.html("Username already existed");
                        return;
                    }
                    if (result.created === 0) {
                        err.html("Error while connected to server");
                        return;
                    }
//                            console.log(result);
                    err.html("Signup success, redirect page");
                    $.post('server/server.php', {'action': 'user_session', 'user_id': result.created}, function () {
